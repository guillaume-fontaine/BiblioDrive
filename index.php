...
<head>
 <title>Projet Biblio Drive</title>
 <meta charset="utf-8">
...
<body class="bg-dark">
 ...
 echo'  <div class="row">
   <div class="col-md-9">
      ...
      <div class="col-md-12">
       <div class="card bg-secondary">
        <div class="card-body">
         <div class="row">
          <div class="col-md-3">
           <a href="http://'.$_SERVER["HTTP_HOST"].'/projet/addbook" class="text-dark">Ajouter un livre</a>
          </div>
          <div class="col-md-3">
           <a href="http://'.$_SERVER["HTTP_HOST"].'/projet/adduser" class="text-dark">Ajouter un utilisateur</a>
          </div>
         </div>
        </div>
       </div>
    ...
    <div class="col-md-3">
     <a href="http://'.$_SERVER["HTTP_HOST"].'/projet">
      <div class="card bg-secondary">
       <div class="card-body">
   ...
   <div class="col-md-9">
    <div class="card bg-secondary">
     ...
     <div class="row">
      ...
      <div class="col-md-3">
       <a href="http://'.$_SERVER["HTTP_HOST"].'/projet/shop" class="text-dark">
        <div class="card bg-secondary">
         <div class="card-body">
...
while($enregistrement = $stmt->fetch()){
	echo'
	<a href="http://'.$_SERVER["HTTP_HOST"].'/projet/bookinfo/?infobook='.$enregistrement->nolivre.'">
	  <div class="item">
